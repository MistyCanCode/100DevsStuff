...
let bulbasourCandies  = 16 - 5
let caterpieCandies = 7 - 1
let weedleCandies = 7 - 1

let candies = bulbasourCandies + caterpieCandies + weedleCandies
console.log(candies)
...
function canCVharmanderBattle(currentTemp){
...
canCVharmanderBattle(33)
canCVharmanderBattle(14)
canCVharmanderBattle(70)
...
undergroundPokemonLeague(['bulbasaour', 'caterpie', 'weedle'])
undergroundPokemonLeague(7)